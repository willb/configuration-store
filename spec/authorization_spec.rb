  ...
  module Grid
    module Config
      ...
      METHOD_META = [[Feature, :annotation, ::Mrg::Grid::Config::Auth::Priv::READ, []], 
                     ...
                     [Store, :checkFeatureValidity, ::Mrg::Grid::Config::Auth::Priv::NONE, [[]]], 
                     [Store, :checkGroupValidity, ::Mrg::Grid::Config::Auth::Priv::NONE, [[]]], 
                     [Store, :checkNodeValidity, ::Mrg::Grid::Config::Auth::Priv::NONE, [[]]], 
                     [Store, :checkParameterValidity, ::Mrg::Grid::Config::Auth::Priv::NONE, [[]]], 
                     [Store, :checkSubsystemValidity, ::Mrg::Grid::Config::Auth::Priv::NONE, [[]]], 
                     ...
                     [Store, :storeinit, ::Mrg::Grid::Config::Auth::Priv::WRITE, []], 
