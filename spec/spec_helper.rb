...
def setup_rhubarb(kwargs=nil)
  ...
  classes = kwargs[:classes] || [Node, Configuration, Feature, Group, Parameter, Subsystem, ArcLabel, ParameterArc, FeatureParams, NodeMembership, GroupParams, GroupFeatures]
